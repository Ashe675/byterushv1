...
export const OrderResume = ({ order }: OrderResumeProps) => {
    ...
    <div className="shadow space-y-1 p-4 bg-white">
      <div className="space-y-2">
        ...
        <p className="text-lg text-gray-700">
          Subtotal: {formatAmount(price * quantity)}
        </p>
      </div>
      ...
      <div className="flex justify-between gap-2 pb-4">
        <button
          type="button"
          onClick={() => handleEditOrder(order.productId)}
          className="bg-accent p-2 text-white rounded-md font-bold uppercase shadow-md text-center cursor-pointer"
        >
          <svg
